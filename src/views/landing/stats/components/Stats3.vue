...
<template>
  ...
  <v-sheet elevation="0" class="mx-auto landing-warpper text-center" color="#F2F5F8" rounded>
    <v-container>
      <v-row align="center">
        <v-col cols="12" md="6">
          <v-sheet color="transparent" elevation="0" class="py-10">
            <img class="mx-auto" width="200" src="@/assets/logo2.svg" alt="" />
            <v-card color="transparent" elevation="0" max-width="800" class="mx-auto my-10">
            ...
            <div>
              <v-btn width="200" height="60" class="text-white mr-5" color="primary">Get Stack</v-btn>
              <v-btn variant="outlined" width="200" height="60" class="text-primary">Watch Demo</v-btn>
            </div>
          </v-sheet>
        </v-col>
        <v-col cols="0" md="6">

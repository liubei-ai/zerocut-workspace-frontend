          ...
          <v-col cols="12">
            <v-card elevation="0" height="100%" class="mx-auto pa-10 pa-md-15 d-flex flex-column justify-center">
              <div>
                ...
                <v-btn color="primary" size="large" class="mt-10">Explore our solutions</v-btn>
              </div>
            </v-card>
          </v-col>
          <v-col cols="12">
            <v-sheet elevation="0" height="100%" class="px-10 px-md-15">
              <v-card v-for="i in 4" color="#F2F5F8" class="px-5 py-10 mb-10 d-flex align-center">
                ...
                <div class="flex-fill">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum rerum blanditiis, veritatis, cumque
                    eligendi aspernatur eveniet provident odit recusandae perspiciatis labore incidunt minus.
                  </p>
                </div>
              </v-card>
            </v-sheet>

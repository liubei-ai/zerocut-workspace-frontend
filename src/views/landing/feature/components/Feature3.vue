...
<template>
  <v-card class="my-5" rounded>
    <v-card-title class="card-title">Feature3</v-card-title>
    <v-divider></v-divider>
    <div>
        ...
        <v-col cols="12" md="6">
          <v-card height="100%">
            <v-img
              height="100%"
              cover
              src="https://images.unsplash.com/photo-1561677978-583a8c7a4b43?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80"
            ></v-img>
          </v-card>
        </v-col>
      </v-row>

export default {
  ...
  oauth: {
    ...
    authorize: '授权',
    cancel: '取消',
    issueCodeFailed: '授权失败',
    manage: {
      title: '我的应用',
      subtitle: '管理你创建的 OAuth 应用。废弃应用不可逆——废弃后此应用永远无法恢复，也不能换 sk。',
      empty: '还没有应用。点击右上角「新建应用」开始。',
      newApp: '新建应用',
      refresh: '刷新',
      stats: {
        total: 'App 总数',
      ...
      deprecate: {
        ...
        warning: '此操作不可逆。',
        consequences:
          '废弃后：所有已颁发的 access_token 立即作废；该 ak 永远不能被任何人重新注册；如要继续使用必须用新 ak 创建新 App。',
        confirmHint: '请输入完整 ak「{ak}」以确认废弃：',
        confirmPlaceholder: '在此输入 ak',
        confirmButton: '我已理解，永久废弃',
        cancel: '取消',
      },
      errors: {
        loadFailed: 'App 列表加载失败',
        createFailed: 'App 创建失败',
        deprecateFailed: '废弃失败',
      },
      messages: {
        createSuccess: 'App 已创建',
        deprecateSuccess: 'App 已废弃',
        copySuccess: '已复制到剪贴板',
      },
    },
  },
  ...
  zerocut: {
    ...
    apikeys: {
      ...
      dialog: {
        create: {
          ...
          expireLabel: '过期时间（可选）',
          expireHint: '留空表示永不过期',
          balanceLabel: '可用余额（可选）',
          balanceHint: '以金额计，留空表示不限额',
          rateLabel: '费率',
          rateHint: '费率 > 0，最多两位小数；创建后不可修改',
          limitComputedLabel: '积分上限（自动计算）',
          limitComputedHint: '积分上限 = 可用余额 × 20 ÷ 费率',
        },
        delete: {
          title: '确认删除',
        ...
        edit: {
          ...
          expireHint: '留空表示永不过期',
          balanceHint:
            '修改可用余额会按当前费率重算额度；调小到等于或低于已消耗会立即冻结此 API Key。',
          balanceLabel: '可用余额',
          rateLabel: '费率',
          rateReadonlyHint: '费率为只读，不可修改',
          limitComputedLabel: '积分上限（自动计算）',
          limitComputedHint: '积分上限 = 可用余额 × 20 ÷ 费率',
        },
      },
      ...
      errors: {
        ...
        invalidRate: '请输入有效的费率（大于0，最多两位小数）',
        invalidBalance: '请输入有效的可用余额（大于0）',
    ...
    subAccount: {
      login: {
        title: '子账号登录',
        subtitle: '使用工作空间 ID 与密钥后 8 位登录',
        workspaceIdLabel: '工作空间 ID',
        workspaceIdPlaceholder: '请输入工作空间 ID',
        suffixLabel: '密钥后 8 位',
        suffixPlaceholder: '请输入 API 密钥的后 8 位',
        submit: '登录',
        failed: '工作空间 ID 或密钥后 8 位不正确',
        invalidInput: '请输入 16 位工作空间 ID 与 8 位密钥后缀',
      },
      consumption: {
        title: '消费记录',
        currentKey: '当前密钥',

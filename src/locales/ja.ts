export default {
  ...
  zerocut: {
    ...
    apikeys: {
      ...
      dialog: {
        create: {
          ...
          balanceLabel: '利用可能残高（任意）',
          balanceHint: '金額で指定。空欄は無制限を意味します',
          rateLabel: 'レート',
          rateHint: 'レートは0より大きく、小数点以下2桁まで。作成後は変更できません',
          limitComputedLabel: 'ポイント上限（自動計算）',
          limitComputedHint: 'ポイント上限 = 利用可能残高 × 20 ÷ レート',
        },
        delete: {
          title: '削除の確認',
        ...
        edit: {
          ...
          expireHint: '空欄は無期限を意味します',
          balanceHint:
            '利用可能残高を変更すると現在のレートで上限を再計算します。消費済み以下に設定すると、このAPIキーは直ちに凍結されます。',
          balanceLabel: '利用可能残高',
          rateLabel: 'レート',
          rateReadonlyHint: 'レートは読み取り専用で変更できません',
          limitComputedLabel: 'ポイント上限（自動計算）',
          limitComputedHint: 'ポイント上限 = 利用可能残高 × 20 ÷ レート',
        },
      },
      ...
      errors: {
        ...
        invalidRate: '有効なレート（0より大きく、小数点以下2桁まで）を入力してください',
        invalidBalance: '有効な利用可能残高（0より大きい値）を入力してください',
    ...
    subAccount: {
      login: {
        title: 'サブアカウントログイン',
        subtitle: 'ワークスペースIDとAPIキーの末尾8文字でログイン',
        workspaceIdLabel: 'ワークスペースID',
        workspaceIdPlaceholder: 'ワークスペースIDを入力',
        suffixLabel: 'キー末尾8文字',
        suffixPlaceholder: 'APIキーの末尾8文字を入力',
        submit: 'ログイン',
        failed: 'ワークスペースIDまたはキーの末尾が正しくありません',
        invalidInput: '16文字のワークスペースIDと8文字のキー末尾を入力してください',
      },
      consumption: {
        title: '消費記録',
        currentKey: '現在のキー',

export default {
  ...
  zerocut: {
    ...
    apikeys: {
      ...
      dialog: {
        create: {
          ...
          balanceLabel: 'Available balance (optional)',
          balanceHint: 'In currency amount; leave empty for unlimited',
          rateLabel: 'Rate',
          rateHint: 'Rate > 0, up to 2 decimals; cannot be changed after creation',
          limitComputedLabel: 'Credits limit (auto-calculated)',
          limitComputedHint: 'Credits limit = available balance × 20 ÷ rate',
        },
        delete: {
        ...
        edit: {
          ...
          expireHint: 'Leave empty for no expiration',
          balanceHint:
            'Changing the available balance recalculates the limit at the current rate. Setting it at or below current consumption immediately freezes this API Key.',
          balanceLabel: 'Available balance',
          rateLabel: 'Rate',
          rateReadonlyHint: 'Rate is read-only and cannot be changed',
          limitComputedLabel: 'Credits limit (auto-calculated)',
          limitComputedHint: 'Credits limit = available balance × 20 ÷ rate',
        },
      },
      ...
      errors: {
        ...
        invalidRate: 'Please enter a valid rate (greater than 0, up to 2 decimals)',
        invalidBalance: 'Please enter a valid available balance (greater than 0)',
    ...
    subAccount: {
      login: {
        title: 'Sub-account Login',
        subtitle: 'Log in with workspace ID and the last 8 characters of an API key',
        workspaceIdLabel: 'Workspace ID',
        workspaceIdPlaceholder: 'Enter workspace ID',
        suffixLabel: 'Key last 8 characters',
        suffixPlaceholder: 'Enter the last 8 characters of the API key',
        submit: 'Log in',
        failed: 'Workspace ID or key suffix is incorrect',
        invalidInput: 'Please enter the 16-character workspace ID and an 8-character key suffix',
      },
      consumption: {
        ...
        loadFail: 'Failed to load consumption records',
      },
    },
    members: {
